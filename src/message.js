	...
	try {
		...
		if (welcome) {
			...
			for (let n of participants) {
				...
				if (action == 'add') {
				let xeonName = n
                const xdate = moment.tz('Europe/Berlin').locale('en-IN').format('DD/MM/YYYY');
                const xtime = moment().tz('Europe/Berlin').locale('en-IN').format('HH:mm:ss');
...
await XeonBotInc.relayMessage(id, msgs.message, {})
				...
				let xeonName = n
                const xeondate = moment.tz('Europe/Berlin').locale('en-IN').format('DD/MM/YYYY');
                const xeontime = moment().tz('Europe/Berlin').locale('en-IN').format('HH:mm:ss');
